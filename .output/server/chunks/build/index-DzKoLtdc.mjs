        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                  ...
                  return [
                    ...
                    createVNode("div", { class: "flex h-full flex-col md:flex-row" }, [
                      createVNode("div", { class: "flex-1 p-8 relative z-10 flex flex-col justify-center" }, [
                        ...
                        createVNode("p", { class: "mt-4 text-neutral-300 max-w-lg" }, " Explorez notre vision d'une sant\xE9 durable \xE0 travers une exp\xE9rience 3D captivante. Interagissez avec notre \xE9cosyst\xE8me naturel et d\xE9couvrez comment nous transformons l'acc\xE8s aux soins de sant\xE9. ")
                      ]),
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="mr-2 text-2xl" data-v-93d42b06${_scopeId2}>\u{1F4AC}</span> Assistant Naturel IA `);
                } else {
                  return [
            ...
            _push2(`</div></div></div><div class="absolute top-10 left-10 text-8xl opacity-10" data-v-93d42b06${_scopeId}>\u{1F33F}</div><div class="absolute bottom-10 right-10 text-9xl opacity-10" data-v-93d42b06${_scopeId}>\u{1F343}</div></section></div>`);
          } else {
            return [
                  ...
                  createVNode("div", { class: "container-custom" }, [
                    createVNode("div", { class: "text-center mb-16" }, [
                      createVNode("div", { class: "inline-block mb-4" }, [
                        createVNode("span", { class: "text-nature-600 dark:text-nature-400 font-semibold text-sm uppercase tracking-wider" }, " \u2728 Exp\xE9rience Interactive ")
                      ]),
                      createVNode("h2", { class: "text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-nature-700 to-nature-500 bg-clip-text text-transparent" }, " D\xE9couvrez Notre Univers 3D "),
                      createVNode("p", { class: "text-nature-700/70 dark:text-nature-300/70 text-lg max-w-3xl mx-auto leading-relaxed" }, " Une exp\xE9rience immersive qui donne vie \xE0 notre engagement pour la sant\xE9 naturelle ")
                    ]),
...
//# sourceMappingURL=index-DzKoLtdc.mjs.map
