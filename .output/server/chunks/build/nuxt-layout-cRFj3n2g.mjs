...
import { a as useNuxtApp, P as PageRouteSymbol, b as useRoute, c as appLayoutTransition, _ as _wrapInTransition, L as LayoutMetaSymbol } from './server.mjs';
import { useRoute as useRoute$1 } from 'vue-router';

const layouts = {
  default: defineAsyncComponent(() => import('./default-B9kbJ_Qr.mjs').then((m) => m.default || m))
};
...
//# sourceMappingURL=nuxt-layout-cRFj3n2g.mjs.map
