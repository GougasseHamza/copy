...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        { name: "description", content: "Trouvez les pharmacies ouvertes pr\xE8s de chez vous au Maroc" }
      ]
    });
            ...
            if (unref(viewMode) === "map" && unref(selectedPharmacy)) {
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Voir les d\xE9tails `);
                  } else {
                    return [
                      createTextVNode(" Voir les d\xE9tails ")
                    ];
                  }
                }),
                _: 1
            ...
            return [
              createVNode("div", { class: "container-custom py-8" }, [
                createVNode("div", {
                  ...
                  createVNode("h1", { class: "text-4xl font-bold mb-2" }, "Pharmacies \xE0 proximit\xE9"),
                  createVNode("p", { class: "text-muted-foreground" }, "Trouvez les pharmacies ouvertes pr\xE8s de chez vous")
                ], 512),
                createVNode("div", {
                ...
                createVNode("div", { class: "grid md:grid-cols-3 gap-6" }, [
                    ...
                    unref(viewMode) === "list" ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "flex gap-4" }, [
                            ...
                            createVNode("div", { class: "flex-1 min-w-0" }, [
                              createVNode("div", { class: "flex items-start justify-between mb-2" }, [
                                ...
                                }, toDisplayString(pharmacy.isOpen ? "Ouverte" : "Ferm\xE9e"), 3)
                              ]),
                      ...
                      createVNode("div", { class: "w-full h-full flex items-center justify-center bg-muted" }, [
                        createVNode("div", { class: "text-center" }, [
                          ...
                          createVNode("p", { class: "text-sm text-muted-foreground mt-2" }, "Int\xE9gration en cours de d\xE9veloppement")
                        ])
                      ])
                    ]))
                  ], 2),
                  unref(viewMode) === "map" && unref(selectedPharmacy) ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "space-y-4" }, [
                      ...
                      createVNode("div", null, [
                        createVNode("p", { class: "text-sm text-muted-foreground mb-1" }, "T\xE9l\xE9phone"),
                      ...
                      createVNode("div", null, [
                        ...
                        }, toDisplayString(unref(selectedPharmacy).isOpen ? "Ouverte" : "Ferm\xE9e"), 3)
                      ]),
                      createVNode("div", null, [
                        createVNode("p", { class: "text-sm text-muted-foreground mb-1" }, "\xC9valuation"),
                        createVNode("div", { class: "flex items-center gap-2" }, [
...
//# sourceMappingURL=pharmacies-De_egLKF.mjs.map
