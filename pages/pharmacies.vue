    ...
    <div class="container-custom pb-16 -mt-6">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div :class="viewMode === 'map' ? 'md:col-span-2' : 'md:col-span-3'">
          ...
          <!-- Map View -->
          <div v-else class="bg-white dark:bg-beige-900 rounded-2xl border-2 border-beige-200 dark:border-beige-700 overflow-hidden shadow-xl" style="height: 600px;">
            <GoogleMap
            ...
            <div v-else class="w-full h-full flex items-center justify-center">
              <div class="text-center">
                <svg class="h-16 w-16 mx-auto text-beige-400 dark:text-beige-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"></path>
                </svg>
                <p class="text-beige-600 dark:text-beige-400">Aucune pharmacie à afficher</p>
              </div>
            </div>
          </div>
        </div>
