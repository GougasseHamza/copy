    ...
    <footer className="border-t mt-20">
      <div className="container-custom py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">PharmFinder</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/pharmacies" className="hover:text-primary">Pharmacies</Link></li>
              <li><Link href="/products" className="hover:text-primary">Produits</Link></li>
              <li><Link href="/chatbot" className="hover:text-primary">Assistant</Link></li>
            </ul>
          </div>
          <div>
