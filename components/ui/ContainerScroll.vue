  ...
  >
    ...
    >
      ...
      <div
        ...
        class="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-earth-400 p-2 md:p-6 bg-beige-700 rounded-[30px] shadow-2xl transition-transform duration-300"
      >
