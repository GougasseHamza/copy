        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="mr-2 text-2xl" data-v-0d9d0886${_scopeId2}>💬</span> Assistant Naturel IA `);
                } else {
                  return [
                    createVNode("span", { class: "mr-2 text-2xl" }, "💬"),
            ...
            _push2(`</div></div></div><div class="absolute top-10 left-10 text-8xl opacity-10" data-v-0d9d0886${_scopeId}>🌿</div><div class="absolute bottom-10 right-10 text-9xl opacity-10" data-v-0d9d0886${_scopeId}>🍃</div></section></div>`);
          } else {
            return [
...
//# sourceMappingURL=index-huzJob0D.js.map
